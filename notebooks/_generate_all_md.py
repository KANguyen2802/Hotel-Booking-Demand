...
def build_stage2():
    ...
    if yoy_data:
        ...
        lines.append("*(Ma trận YoY được tính từ notebook `03_eda_stage2_adr.ipynb`.)*")
...
> **Nguồn:** Kết hợp [02 02 EDA Stage 1 — Cancellation](02_eda_stage1_cancellation_analysis.md) và [03 03 EDA Stage 2 — ADR](03_eda_stage2_adr_analysis.md)  
> **Dữ liệu:** `hotel_bookings_v4.csv` (Stage 1) · `hotel_bookings_v5.csv` (Stage 2, tái tạo từ v4 + `day_of_week`)  
> **Notebook:** `02_eda_stage1_cancellation.ipynb` · `03_eda_stage2_adr.ipynb`  
...
|---|---|:---:|
| [02 EDA Stage 1 — Cancellation](02_eda_stage1_cancellation_analysis.md) | lead_time, deposit, segment, channel | 11 |
| [03 EDA Stage 2 — ADR](03_eda_stage2_adr_analysis.md) | month, day_of_week, room_type, customer_type | 11 |
...
def write_all():
    files = {
        "02_eda_stage1_cancellation_analysis.md": build_stage1(),
        "03_eda_stage2_adr_analysis.md": build_stage2(),
        "03_summary_eda_key_findings.md": build_summary(),
        "04_correlation_analysis_is_canceled.md": build_correlation(),
        "05_hypothesis_testing_is_canceled.md": build_hypothesis(),
