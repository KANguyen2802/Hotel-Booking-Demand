...
> **Tổng hợp từ:** [02 EDA Stage 1](02_eda_stage1_cancellation_analysis.md) · [03 EDA Stage 2](03_eda_stage2_adr_analysis.md)
> **Dữ liệu:** `hotel_bookings_v4.csv` (Stage 1) · `hotel_bookings_v5.csv` (Stage 2, tái tạo từ v4 + `day_of_week`)
> **Notebook tham chiếu:** `02_eda_stage1_cancellation.ipynb` · `03_eda_stage2_adr.ipynb`
