...
<img src="figures/brd_v1_1_as_is_flowchart.png" alt="Sơ đồ quy trình As-Is — tiếp nhận và xác nhận đặt phòng thủ công" width="800">
...
| `models/Cancellation Predict Model v2/09_cancellation_model_v2.ipynb` | Notebook huấn luyện & đánh giá v2 |
